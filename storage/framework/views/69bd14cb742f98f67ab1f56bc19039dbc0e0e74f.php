...
<div class="panel panel-flat ">
    ...
    <div class="panel-body col-sm-offset-2">
        ...
        <form action="<?php echo e(url('admin/savededitbroker')); ?>" class="smart-wizard form-horizontal" method="post">
            <input name="_token" type="hidden" value="<?php echo e(csrf_token()); ?>">
              <input name="id" type="hidden" value="<?php echo e($broker->id); ?>">
            <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input class="form-control" id="name" name="name" value="<?php echo e($broker->name); ?>" type="text" required="true">
                    </input>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input class="form-control" id="url" name="url" value="<?php echo e($broker->url); ?>" type="text" required="true">
                    </input>
                </div>
            </div>
             <div class="form-group">
                <label class="col-sm-3 control-label" for="current_password">
                 ...
                 <div class="col-sm-4">
                    <select name="status" id=status class="form-control">
                         <option value="<?php echo e($broker->status); ?>"><?php echo e($broker->status); ?></option>
                        <?php if($broker->status == 'enabled'): ?>
                       <option value="disabled">disabled</option>
                        <?php endif; ?> 
                         <?php if($broker->status == 'disabled'): ?>
